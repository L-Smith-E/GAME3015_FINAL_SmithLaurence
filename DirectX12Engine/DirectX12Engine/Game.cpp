...
void Game::BuildMaterials()
{
	...
	auto TitleBGTex = std::make_unique<Material>();
	TitleBGTex->Name = "TitleBGTex";
	TitleBGTex->MatCBIndex = 3;
	TitleBGTex->DiffuseSrvHeapIndex = 3;
	TitleBGTex->DiffuseAlbedo = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	TitleBGTex->FresnelR0 = XMFLOAT3(0.05f, 0.05f, 0.05f);
	TitleBGTex->Roughness = 0.2f;
